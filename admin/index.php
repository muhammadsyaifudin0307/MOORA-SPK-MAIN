    ...
    <div class="container mt-5">
        ...
        ?>
                ...
                <p class="text-center text-dark font-weight-bold">
                    Dalam metode MOORA, alternatif dengan peringkat tertinggi adalah
                    <strong class="text-primary"><?= htmlspecialchars($topRank['nama_alternatif']) ?></strong>
                    dengan nilai <strong class="text-primary"><?= number_format($topRank['nilai_moora'], 4) ?></strong>.
            ...
            ?>
                ...
                <p class="text-center text-dark font-weight-bold">
                    Tidak ada alternatif yang tersedia dalam metode MOORA saat ini.
                </p>
